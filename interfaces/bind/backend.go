...
// Setup creates bind profile files specific to a given snap.
//
...
func (b *Backend) Setup(snapInfo *snap.Info, devMode bool, repo *interfaces.Repository) error {
	...
	snippets, err := repo.SecuritySnippetsForSnap(snapInfo.Name(), interfaces.SecurityBind)
	if err != nil {
...
func (b *Backend) Remove(snapName string) error {
	glob := fmt.Sprintf("%s.bind", interfaces.SecurityTagGlob(snapName))
	_, _, err := osutil.EnsureDirState(dirs.SnapBindPolicyDir, glob, nil)
	if err != nil {
