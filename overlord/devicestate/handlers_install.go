...
func (m *DeviceManager) doSetupRunSystem(t *state.Task, _ *tomb.Tomb) error {
	...
	useEncryption, err := checkEncryption(deviceCtx.Model(), kernelInfo)
	if err != nil {
		return err
	}
...
func checkEncryption(model *asserts.Model, kernelInfo *snap.Info) (res bool, err error) {
	...
	if err := secbootCheckKeySealingSupported(kernelInfo); err != nil {
		if secured {
